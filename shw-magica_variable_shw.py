...
--> Spatially varying electric field implementation with explicit shield wire modelling <--
...
def input_output(X):
    ...
    out_name        =   'variable_Efield_with_shw'+filename1[:-4]                 
    
    return testfield,networkpath,connectionspath,shw_networkpath, shw_connectionspath,Efield_pkl,Points_pkl,out_name, SavePath;
...
testfield,networkpath,connectionspath,shw_networkpath,shw_connectionspath,Efield_pkl,Points_pkl,out_name,SavePath      =input_output('x')
...
for i in range(0, nconnects_E):
    ...
    #mother_line_E[i] = int(conns[5].split("\n")[0])
